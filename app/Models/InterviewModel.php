...
class InterviewModel
{
  ...
  {
    $this->db->query('INSERT INTO interview (cv_id, interview_date) 
  ...
  {
    $this->db->query('INSERT INTO interviewinvitation (interview_id, user_id, invitation_title, invitation_content) 
